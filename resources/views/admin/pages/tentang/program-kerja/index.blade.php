...
@section('page-subtitle', 'Kelola program kerja institusi')
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <span class="text-lg font-semibold text-gray-700">Program Kerja</span>
            </div>
            ...
            <button @click="$dispatch('open-create')"
                ...
                <span class="font-semibold">Tambah Program Kerja</span>
            </button>
        </div>
    </div>

    <div id="ajax-table-container">
        @include('admin.pages.tentang.program-kerja.partials.table')
    </div>

    @include('admin.pages.tentang.program-kerja.partials.form-create')

    @include('admin.pages.tentang.program-kerja.partials.form-edit')

    @include('admin.pages.tentang.program-kerja.partials.form-show')
