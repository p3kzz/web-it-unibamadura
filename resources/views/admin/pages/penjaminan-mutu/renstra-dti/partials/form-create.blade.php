<div x-data="{
    ...
    x-on:open-create-renstra-dti.window="
        open = true;
        fileName = '';
        $nextTick(() => {
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Tambah Renstra DTI</h3>
                    <p class="text-blue-100 text-sm">Buat Renstra DTI baru</p>
                </div>
            </div>
        ...
        <form method="POST" action="{{ route('admin.penjaminan.renstra-dti.store') }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="space-y-5">
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">
                        File Renstra DTI (PDF) <span class="text-red-500">*</span>
                    </label>
                    <div class="relative">
