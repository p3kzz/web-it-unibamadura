        ...
        <div class="flex justify-between h-20">
            <div class="flex items-center">
                <a href="/" class="flex items-center gap-3 group">
                    <img src="{{ $konfigurasilogo?->logo_web_url ?? asset('images/logo/logo.webp') }}" alt="UNIBA Madura"
                    ...
                    <div class="leading-tight">
                        <h1 class="text-xl font-bold text-uniba-blue group-hover:text-blue-700 transition-colors">
                            {{ $konfigurasilogo?->nama_web ?? 'UNIBA Madura' }}</h1>
