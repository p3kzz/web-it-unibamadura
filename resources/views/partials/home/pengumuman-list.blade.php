<div class="space-y-4">
    @forelse ($announcementItems as $item)
        <article
            class="bg-white p-4 border-l-4 border-amber-500 shadow-sm rounded-r-lg flex items-start hover:shadow-md transition-shadow duration-300 transform hover:translate-x-1">
            <div class="flex-1">
                ...
                <h4 class="font-bold text-gray-800 transition-colors line-clamp-2">
                    {{ $item->title }}
                </h4>
