        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($items as $index => $item)
                    @include('admin.pages.kebijakan.kategori.partials.table-row')
                @empty
                    @include('admin.pages.kebijakan.kategori.partials.empty-state')
                @endforelse
            </tbody>
        </table>
    </div>
...
@include('admin.pages.kebijakan.kategori.partials.mobile-card')
