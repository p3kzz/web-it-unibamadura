...
@section('title', 'Lisensi Software - UPT TIK UNIBA Madura')
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <p class="text-lg md:text-xl text-blue-100 mb-10 animate-fade-in-up stagger-2 max-w-2xl mx-auto">
                    Informasi lisensi software resmi yang digunakan untuk mendukung operasional dan layanan digital UPT
                    TIK.
                </p>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                <div class="bg-white rounded-2xl p-4 md:p-6 shadow-lg text-center border border-gray-100">
                    <div class="text-2xl md:text-3xl font-bold text-uniba-blue">{{ $licenses->total() }}</div>
                    <div class="text-xs md:text-sm text-gray-500 font-medium">Total Lisensi</div>
                </div>
                <div class="bg-white rounded-2xl p-4 md:p-6 shadow-lg text-center border border-gray-100">
                    <div class="text-2xl md:text-3xl font-bold text-emerald-600">{{ $licenses->count() }}</div>
                    <div class="text-xs md:text-sm text-gray-500 font-medium">Ditampilkan Saat Ini</div>
                </div>
                <div class="bg-white rounded-2xl p-4 md:p-6 shadow-lg text-center border border-gray-100">
                    <div class="text-2xl md:text-3xl font-bold text-amber-600">
                        {{ $licenses->sum('sections_count') }}
                    </div>
                    <div class="text-xs md:text-sm text-gray-500 font-medium">Total Bagian Lisensi</div>
                </div>
                <div class="bg-white rounded-2xl p-4 md:p-6 shadow-lg text-center border border-gray-100">
    ...
    <section class="py-14 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8">
                @forelse ($licenses as $index => $item)
                    <a href="{{ route('lisensi-software.show', $item->slug) }}"
                        ...
                        <div class="p-6 lg:p-8">
                            ...
                            <p class="text-gray-500 text-sm mb-6 line-clamp-3 leading-relaxed">
                                {{ \Illuminate\Support\Str::limit(strip_tags($item->short_description ?: 'Informasi lisensi software tersedia untuk kebutuhan layanan institusi.'), 150) }}
                            </p>
                ...
                @empty
                    <div class="md:col-span-2 xl:col-span-3 scroll-animate">
                        <div class="bg-white border-2 border-dashed border-gray-200 rounded-3xl p-12 md:p-16 text-center">
                            ...
                            <h3 class="font-bold text-xl text-gray-900 mb-2">Belum ada lisensi software</h3>
                            <p class="text-gray-500 mb-8 max-w-md mx-auto">
                                Data lisensi software belum dipublikasikan. Silakan cek kembali beberapa saat lagi.
                            </p>
                            <a href="{{ route('home') }}"
