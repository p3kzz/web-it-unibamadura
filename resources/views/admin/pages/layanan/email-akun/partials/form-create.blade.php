<div x-data="{
    ...
    initEditor(section, index) {
        this.$nextTick(() => {
            const editorId = `create-email-akun-content-${section.uid}`;
            const $el = $('#' + editorId);
    ...
    x-on:open-create-email-akun.window="
    open = true;
    resetForm();
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Tambah Email Akun</h3>
        ...
        <form method="POST" action="{{ route('admin.layanan.email-akun.store') }}" @submit="syncAllEditors()"
            class="p-6">
            @csrf
            ...
            <div class="space-y-5">
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">
                        Judul Email Akun <span class="text-red-500">*</span>
                    </label>
                ...
                <div class="border-t border-gray-200 pt-5">
                    <div class="flex items-center justify-between mb-4">
                        <label class="block text-sm font-bold text-gray-700">
                            Bagian Email Akun <span class="text-red-500">*</span>
                        </label>
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-200">
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <x-form-summernote id="" name="" ::id="`create-email-akun-content-${section.uid}`" ::name="`sections[${index}][content]`"
                                        :value="''" height="180" />
                                </div>
                            </div>
                        </div>
