<div x-data="{
    ...
    x-on:open-edit-konfigurasi-footer.window="
        open = true;
        form = {
            id: $event.detail.id,
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <form :action="`/admin_tik/konfigurasi-footer/${form.id}`" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="url" rows="5" x-model="form.url"
                        ...
                        placeholder="Masukkan URL {{ $type }} dengan detail..." required></textarea>
