<div x-data="{
    ...
    initEditor(section, index) {
        this.$nextTick(() => {
            const editorId = `edit-tinjauan-manajemen-content-${section.uid}`;
            const $el = $('#' + editorId);
    ...
    x-on:open-edit-tinjauan-manajemen.window="
    form = {
        id: $event.detail.id,
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Edit Tinjauan Manajemen</h3>
        ...
        <form :action="`/admin_tik/tinjauan-manajemen/${form.slug || form.id}`" method="POST" @submit="syncAllEditors()"
            class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="title" x-model="form.title"
                        ...
                        placeholder="Contoh: Tinjauan Manajemen" required>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" x-model="form.description"
                        ...
                        placeholder="Masukkan deskripsi singkat penjaminan mutu tinjauan manajemen..."></textarea>
                </div>
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-200">
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <x-form-summernote id="" name="" ::id="`edit-tinjauan-manajemen-content-${section.uid}`" ::name="`sections[${index}][content]`"
                                        :value="''" height="180"
