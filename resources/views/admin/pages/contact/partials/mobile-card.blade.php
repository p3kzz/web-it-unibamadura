<div class="lg:hidden space-y-3 px-1">
    ...
    <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-4 space-y-3">
        @include('admin.pages.contact.partials.search')
    </div>
        ...
        <div
            ...
            <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-gray-50">
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Kontak</p>
                    </div>
                </div>
            ...
            <div class="p-4 space-y-3">
                ...
                <div>
                    <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1">Nilai</p>
                ...
                @if ($item->type)
                    <div>
                        ...
                        <p class="text-sm text-gray-900">{{ ucfirst($item->type) }}</p>
                    </div>
                @endif
            </div>

            <div class="grid grid-cols-3 gap-2 px-4 pb-4">
                <button @click="$dispatch('open-show-contact', {{ $item->toJson() }})"
                ...
                <button @click="$dispatch('open-edit-contact', {{ $item->toJson() }})"
                    class="inline-flex items-center justify-center gap-2 px-4 py-2.5
                ...
                <form method="POST" action="{{ route('admin.contact.destroy', $item) }}"
