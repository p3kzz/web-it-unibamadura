<tr class="hover:bg-blue-50 transition-colors duration-150 group">
    ...
    <td class="px-6 py-4 align-top">
        <div class="text-sm leading-relaxed break-words line-clamp-3">
            <a href="{{ $item->url }}" target="_blank" rel="noopener noreferrer"
                class="text-uniba-blue hover:text-blue-700 hover:underline transition-colors cursor-pointer">
                {{ $item->url }}
            </a>
        </div>
    </td>
    ...
    <td class="px-6 py-4 align-top">
        <div class="flex items-center justify-center gap-2">
            ...
            <button @click="$dispatch('open-edit-konfigurasi-footer', {{ $item->toJson() }})" title="Edit data"
