...
@section('page-subtitle', 'Kelola konten sejarah institusi')
...
@section('content')
    ...
    <div id="ajax-table-container">
        @include('admin.pages.tentang.sejarah.partials.table')
    </div>

    @include('admin.pages.tentang.sejarah.partials.form-create')
