<div x-data="{ open: false }" x-on:open-create-contact.window="open = true" x-show="open" x-cloak
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-blue-100 text-sm">Isi form di bawah untuk menambah data kontak baru</p>
                </div>
            </div>
        ...
        <form method="POST" action="{{ route('admin.contact.store') }}" class="p-6 overflow-y-auto flex-1">
            @csrf
            <div class="space-y-5">
                <div>
