<div x-data="{
    open: false,
    katalogLayananId: {{ $katalogLayananId ?? 'null' }},
    sections: [],
    ...
    resetForm() {
        ...
        this.sections.forEach((section) => {
            const editorId = `create-detail-layanan-content-${section.uid}`;
            const $el = $('#' + editorId);
        ...
        this.katalogLayananId = {{ $katalogLayananId ?? 'null' }};
    },
    ...
    initEditor(section, index) {
        this.$nextTick(() => {
            ...
            // Ensure content is empty/cleared
    ...
    x-on:open-create-detail-layanan.window="
    open = true;
    resetForm();
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Tambah Detail Layanan</h3>
                    <p class="text-blue-100 text-sm">Isi form di bawah untuk menambah detail layanan baru</p>
                </div>
            </div>
        ...
        <form method="POST" action="{{ route('admin.layanan.detail-layanan.store') }}" @submit="syncAllEditors()"
            class="p-6">
            @csrf

            <input type="hidden" name="katalog_layanan_id" x-model="katalogLayananId" required>
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="title"
                        ...
                        value="{{ old('title') }}" placeholder="Contoh: Panduan Lengkap Layanan" required>
                    @error('title')
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-200">
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <x-form-summernote id="" name="" ::id="`create-detail-layanan-content-${section.uid}`" ::name="`sections[${index}][content]`"
