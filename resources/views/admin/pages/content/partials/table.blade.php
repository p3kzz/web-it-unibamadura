            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">
                        {{ $search ? "Hasil pencarian: {$items->count()} data" : "Total: {$items->count()} data" }}
                    </p>
                </div>
            </div>
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($items as $index => $item)
                    @include('admin.pages.content.partials.table-row')
                @empty
...
@include('admin.pages.content.partials.mobile-card')
