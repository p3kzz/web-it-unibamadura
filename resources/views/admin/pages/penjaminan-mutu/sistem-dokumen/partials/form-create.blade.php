<div x-data="{
    ...
    x-on:open-create-sistem-dokumen.window="
        open = true;
        fileName = '';
        $nextTick(() => {
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Tambah Dokumen</h3>
                    <p class="text-blue-100 text-sm">Buat dokumen baru</p>
                </div>
            </div>
        ...
        <form method="POST" action="{{ route('admin.sistem-dokumen.store') }}" enctype="multipart/form-data"
            class="p-6">
            @csrf
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="judul"
                        ...
                        placeholder="Contoh: Blueprint TIK 2020-2024" value="{{ old('judul') }}" required>
                    @error('judul')
