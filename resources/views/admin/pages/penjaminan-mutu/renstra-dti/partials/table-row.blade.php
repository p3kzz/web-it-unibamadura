<tr class="hover:bg-gray-50 transition-colors duration-150">
    ...
    <td class="px-6 py-4">
        <div class="flex items-center justify-center gap-1">
            ...
            <form action="{{ route('admin.penjaminan.renstra-dti.destroy', $item) }}" method="POST" class="inline"
                onsubmit="return confirm('Apakah Anda yakin ingin menghapus Renstra DTI ini?')">
                @csrf
                @method('DELETE')
                <button type="submit"
