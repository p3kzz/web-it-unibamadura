    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Detail Audit</h3>
                    <p class="text-blue-100 text-sm">Informasi lengkap penjaminan mutu audit</p>
                </div>
            </div>
        ...
        <div class="p-6 space-y-6">
            ...
            <template x-if="item.sections && item.sections.length > 0">
                <div>
                    <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-3">Bagian Audit</p>
                    <div class="space-y-4">
