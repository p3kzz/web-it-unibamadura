<div x-data="{
    ...
    x-on:open-edit-kategori-layanan.window="
        open = true;
        form = {
            id: $event.detail.id,
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Edit Kategori Layanan</h3>
        ...
        <form :action="`/admin_tik/kategori-layanan/${form.id}`" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <label class="text-sm text-gray-700">Jadikan sebagai kategori aktif</label>
                </div>
