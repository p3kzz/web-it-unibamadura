    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Tambah SOP</h3>
                    <p class="text-blue-100 text-sm">Buat Standard Operating Procedure baru</p>
                </div>
            </div>
        ...
        <form method="POST" action="{{ route('admin.sop.store') }}" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="judul"
                        ...
                        placeholder="Contoh: SOP Peminjaman Peralatan" value="{{ old('judul') }}" required>
                    @error('judul')
                ...
                <div>
                    ...
                    <x-form-summernote id="deskripsi-create" name="deskripsi" :value="old('deskripsi')" height="150" />
                </div>

                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">
                        File SOP (PDF) <span class="text-red-500">*</span>
                    </label>
                    <div class="relative">
