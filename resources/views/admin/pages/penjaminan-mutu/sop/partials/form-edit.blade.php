    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Edit SOP</h3>
        ...
        <form :action="`{{ url('admin_tik/sop') }}/${form.id}`" method="POST" enctype="multipart/form-data"
            class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="judul" x-model="form.judul"
                        ...
                        placeholder="Contoh: SOP Peminjaman Peralatan" required>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <label class="text-sm text-gray-700">Aktifkan SOP ini</label>
                </div>
