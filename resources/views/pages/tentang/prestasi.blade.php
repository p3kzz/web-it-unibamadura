    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-6xl mx-auto">
                @php
                    $colors = ['red', 'blue', 'purple', 'green', 'indigo', 'pink'];
                    $icons = [
                ...
                @if ($prestasi->isEmpty())
                    <div class="text-center py-16">
                        ...
                        <p class="text-gray-500 text-lg">Belum ada prestasi yang ditampilkan</p>
                    </div>
                @else
                    <div class="space-y-6">
                                    ...
                                    <div class="md:flex">
                                        <div
                                            ...
                                            <div class="relative z-10 text-center">
                                                <div class="text-6xl text-gray-950 font-bold mb-4">{{ $item->year }}</div>
                                                <div
                                        ...
                                        <div class="md:w-3/4 p-8">
                                            <div class="flex items-start justify-between mb-4">
                                                <div>
                                                    <h3 class="text-2xl font-bold text-gray-900 mb-2">{{ $item->title }}
                                                    </h3>
                                                    <span
                                                        class="inline-flex items-center gap-2 text-sm text-{{ $color }}-600 font-semibold">
                                                ...
                                                <div class="flex-shrink-0 ml-4">
                                                    <span
                                                        class="inline-block w-12 h-12 bg-{{ $color }}-100 rounded-full flex items-center justify-center">
                                            ...
                                            <div class="mt-4 pt-4 border-t border-gray-100">
                                                <span class="text-sm text-gray-500">
                                                    ...
                                                    {{ $item->achievement_date->format('d F Y') }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
