    ...
    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between gap-4 mb-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="font-bold text-gray-800">Daftar Tinjauan Manajemen</h3>
        ...
        <div class="flex flex-col md:flex-row gap-3">
            @include('admin.pages.penjaminan-mutu.tinjauan-manajemen.partials.search')
        </div>
    </div>
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($items as $index => $item)
                    @include('admin.pages.penjaminan-mutu.tinjauan-manajemen.partials.table-row')
                @empty
                    @include('admin.pages.penjaminan-mutu.tinjauan-manajemen.partials.empty-state')
                @endforelse
            </tbody>
        </table>
    </div>
...
@include('admin.pages.penjaminan-mutu.tinjauan-manajemen.partials.mobile-card')
