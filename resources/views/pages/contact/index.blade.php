...
@section('content')
    ...
    <section class="relative z-10 -mt-8">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-2xl p-4 md:p-6 shadow-lg text-center border border-gray-100 hover:shadow-xl transition-shadow scroll-animate" style="animation-delay: 0.1s;">
                ...
                <div class="bg-white rounded-2xl p-4 md:p-6 shadow-lg text-center border border-gray-100 hover:shadow-xl transition-shadow scroll-animate" style="animation-delay: 0.2s;">
                ...
                <div class="bg-white rounded-2xl p-4 md:p-6 shadow-lg text-center border border-gray-100 hover:shadow-xl transition-shadow scroll-animate" style="animation-delay: 0.3s;">
                            ...
                            @if ($groupedByType->has($type))
                                <div class="scroll-animate stagger-{{ ($loop->index + 1) }}">
                                    <div
                                        ...
                                        <div class="bg-gradient-to-r {{ $info['gradient'] }} p-8 flex items-center gap-4 relative overflow-hidden">
                                            <div class="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
                                            <div
                                                        ...
                                                        <div class="flex items-start gap-4 p-4 rounded-xl hover:bg-gray-50 transition-colors">
                                                            ...
                                                            <div class="min-w-0 flex-1">
                                                                <h3 class="font-semibold text-gray-900 mb-1.5">
                                                                    {{ $contact->label }}</h3>
                                                                <p class="text-gray-600 break-words text-sm leading-relaxed hover:text-{{ $info['color'] }}-600 transition-colors">
                                                                    {{ $contact->value }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div
                                            ...
                                            <p class="text-xs text-gray-500 flex items-center gap-2">
                                                <svg class="w-4 h-4 text-{{ $info['color'] }}-500" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="mt-16">
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div
                                ...
                                <div class="w-14 h-14 bg-blue-500 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
                            ...
                            {{-- Card 2 --}}
                            <div
                                class="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 border border-green-200 hover:shadow-lg transition-shadow scroll-animate" style="animation-delay: 0.1s;">
                                <div class="w-14 h-14 bg-green-500 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
                                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            {{-- Card 3 --}}
                            <div
                                class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8 border border-purple-200 hover:shadow-lg transition-shadow scroll-animate" style="animation-delay: 0.2s;">
                                <div class="w-14 h-14 bg-purple-500 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
                                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Hubungi kami kapan saja melalui berbagai saluran komunikasi yang tersedia sepanjang waktu
                                </p>
                            </div>
                        </div>
                    </div>
                @else
                    ...
                    <div class="text-center py-20">
                        ...
                        <p class="text-gray-500 max-w-md mx-auto">
                            Informasi kontak belum tersedia untuk ditampilkan saat ini. Silahkan hubungi admin untuk informasi lebih
                            lanjut.
                        </p>
                    </div>
                @endif
    ...
    <section class="py-20 bg-gradient-to-br from-uniba-blue via-blue-700 to-uniba-dark relative overflow-hidden">
        <div class="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
        <div class="absolute top-10 -left-20 w-96 h-96 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
        <div class="absolute bottom-10 -right-20 w-96 h-96 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-4xl mx-auto text-center scroll-animate">
                ...
                <p class="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
                    Jangan ragu untuk menghubungi kami melalui salah satu saluran komunikasi di atas. Tim kami akan segera merespon dengan solusi terbaik untuk Anda.
                </p>
