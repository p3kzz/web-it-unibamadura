<div x-data="{
    ...
    x-on:open-edit-policy.window="
        ...
        $nextTick(() => {
            initSummernote('content-edit', form.content);
        });
    "
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Edit Kebijakan</h3>
            ...
            <div class="space-y-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <select name="policy_category_id" x-model="form.category_id"
                            class="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 focus:border-uniba-blue focus:ring-2 focus:ring-uniba-blue focus:ring-opacity-20 transition-all duration-200 outline-none"
                            required>
                ...
                <div>
                    ...
                    <textarea name="excerpt" rows="2" x-model="form.excerpt"
                        class="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 focus:border-uniba-blue focus:ring-2 focus:ring-uniba-blue focus:ring-opacity-20 transition-all duration-200 outline-none"
                        placeholder="Ringkasan singkat tentang kebijakan ini"></textarea>
                </div>
                ...
                <div>
                    ...
                    <x-form-summernote id="content-edit" name="content" :value="''" height="250" />
                </div>
