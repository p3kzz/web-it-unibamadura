    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <button @click="$dispatch('open-create-web-hosting')"
                ...
                <span class="font-semibold">Tambah Web Hosting</span>
            </button>
        </div>
    </div>

    <div id="ajax-table-container">
        @include('admin.pages.layanan.web-hosting.partials.table')
    </div>

    @include('admin.pages.layanan.web-hosting.partials.form-create')

    @include('admin.pages.layanan.web-hosting.partials.form-edit')

    @include('admin.pages.layanan.web-hosting.partials.form-show')
