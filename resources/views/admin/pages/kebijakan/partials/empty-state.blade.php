<tr>
    <td colspan="6" class="px-6 py-16 text-center">
        <div class="flex flex-col items-center justify-center">
            ...
            <h3 class="text-lg font-semibold text-gray-700 mb-1">Belum ada data Kebijakan</h3>
            <p class="text-sm text-gray-500 mb-4">Mulai tambahkan kebijakan pertama Anda</p>
