<div x-data="{
    ...
    x-on:open-show-sistem-dokumen.window="
        open = true;
        item = {
            id: $event.detail.id,
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-blue-100 text-sm">Informasi lengkap dokumen</p>
                </div>
            </div>
        ...
        <div class="p-6 space-y-6">
            <div>
                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Judul
                    Dokumen</label>
            ...
            <div>
                ...
                <template x-if="item.file">
                    <a :href="`/storage/${item.file}`" target="_blank"
                        ...
                        <div>
                            <p class="font-semibold text-gray-800">Dokumen</p>
            ...
            <div class="flex justify-end gap-3 pt-6 border-t border-gray-200">
                ...
                <button @click="open = false; $dispatch('open-edit-sistem-dokumen', item)"
