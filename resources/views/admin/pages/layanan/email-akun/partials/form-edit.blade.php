<div x-data="{
    ...
    x-on:open-edit-email-akun.window="
    form = {
        id: $event.detail.id,
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Edit Email Akun</h3>
        ...
        <form :action="`/admin_tik/email-akun/${form.slug || form.id}`" method="POST" @submit="syncAllEditors()"
            class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="title" x-model="form.title"
                        ...
                        placeholder="Contoh: Layanan Email Akun Kampus" required>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" x-model="form.description"
                        ...
                        placeholder="Masukkan deskripsi singkat layanan email akun..."></textarea>
                </div>
