...
@section('page-title', 'Berita, Pengumuman & Agenda')
@section('page-subtitle', 'Kelola konten berita, pengumuman dan agenda TIK UNIBA')
...
@section('content')
    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <button @click="$dispatch('open-create-content')"
    ...
    <div id="ajax-table-container">
        @include('admin.pages.content.partials.table')
    </div>
