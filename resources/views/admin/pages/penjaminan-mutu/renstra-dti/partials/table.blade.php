        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($items as $index => $item)
                    @include('admin.pages.penjaminan-mutu.renstra-dti.partials.table-row')
                @empty
                    @include('admin.pages.penjaminan-mutu.renstra-dti.partials.empty-state')
                @endforelse
            </tbody>
        </table>
    </div>
...
@include('admin.pages.penjaminan-mutu.renstra-dti.partials.mobile-card')
