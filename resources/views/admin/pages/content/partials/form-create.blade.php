<div x-data="{ open: false }" x-on:open-create-content.window="open = true" x-show="open" x-cloak
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input type="file" name="thumbnail" accept="image/*"
                        class="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 focus:border-uniba-blue focus:ring-2 focus:ring-uniba-blue focus:ring-opacity-20 transition-all duration-200 outline-none text-sm">
                ...
                @if ($section === 'news')
                    <div>
                        ...
                        <textarea name="excerpt" rows="2"
                            ...
                            placeholder="Masukkan ringkasan berita (max 500 karakter)" maxlength="500" required>{{ old('excerpt') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="content" rows="5"
                        class="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 focus:border-uniba-blue focus:ring-2 focus:ring-uniba-blue focus:ring-opacity-20 transition-all duration-200 outline-none resize-none"
                        placeholder="Masukkan konten dengan detail..." required>{{ old('content') }}</textarea>
                    @error('content')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                @if (in_array($section, ['agendas', 'announcement']))
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">
                ...
                <div>
                    ...
                    <textarea name="meta_description" rows="2"
                        class="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 focus:border-uniba-blue focus:ring-2 focus:ring-uniba-blue focus:ring-opacity-20 transition-all duration-200 outline-none resize-none"
                        placeholder="Untuk SEO" maxlength="255">{{ old('meta_description') }}</textarea>
                    <p class="mt-1 text-xs text-gray-500">Max: 255 karakter</p>
