<tr class="hover:bg-blue-50 transition-colors duration-150 group">
    ...
    <td class="px-6 py-4 align-top">
        <div class="flex items-center justify-center gap-2">
            <button @click="$dispatch('open-show-tinjauan-manajemen', {{ $item->toJson() }})" title="Lihat detail"
            ...
            <button @click="$dispatch('open-edit-tinjauan-manajemen', {{ $item->toJson() }})" title="Edit data"
