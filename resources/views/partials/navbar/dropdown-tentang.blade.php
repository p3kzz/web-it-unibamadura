<div class="relative group">
    ...
    <div
        class="absolute left-0 top-full w-56 bg-white border-t-4 border-uniba-yellow shadow-lg py-2 rounded-b-lg invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
        <a href="/visi-misi" class="block px-4 py-2 hover:bg-gray-50 hover:text-uniba-blue transition-colors">Visi &
            Misi</a>
        ...
        <a href="/sumber-daya-manusia"
            class="block px-4 py-2 hover:bg-gray-50 hover:text-uniba-blue transition-colors">Sumber Daya
            Manusia</a>
