<div x-data="{
    ...
    initEdit(data) {
        this.item = data;
        this.thumbnailPreview = null; // Reset preview saat buka data baru
        this.open = true;
    }
}" x-on:open-edit-content.window="initEdit($event.detail)" x-show="open" x-cloak
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">Konten <span
                            class="text-red-500">*</span></label>
                    <textarea name="content" x-model="item.content" rows="4"
                        class="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 focus:border-uniba-blue outline-none" required></textarea>
                </div>
