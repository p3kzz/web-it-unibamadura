<div x-data="{
    ...
    x-on:open-edit.window="
        ...
        form = {
            ...
            key_components: $event.detail.key_components || [],
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Edit Pilar Transformasi</h3>
        ...
        <form :action="`/admin_tik/pilar-transformasi/${form.id}`" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="title" x-model="form.title"
                            class="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 transition-all duration-200 outline-none"
                            placeholder="Masukkan judul pilar" required>
                    </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" x-model="form.description"
                        ...
                        placeholder="Masukkan deskripsi pilar transformasi..."></textarea>
                </div>

                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">Komponen Utama</label>
                    <div class="space-y-2">
                        <template x-for="(component, index) in form.key_components" :key="index">
                            <div class="flex gap-2">
                                <input type="text" :name="'key_components[' + index + ']'"
                                    x-model="form.key_components[index]"
                                    class="flex-1 border-2 border-gray-300 rounded-lg px-4 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 transition-all duration-200 outline-none"
                                    placeholder="Masukkan komponen">
                                <button type="button" @click="form.key_components.splice(index, 1)"
                    ...
                    <button type="button" @click="form.key_components.push('')"
                        class="mt-2 inline-flex items-center gap-2 px-3 py-2 text-sm bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
