<div x-data="{
    ...
    x-on:open-edit-sistem-dokumen.window="
        open = true;
        form = {
            id: $event.detail.id,
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <form :action="`{{ url('admin_tik/sistem-dokumen') }}/${form.id}`" method="POST" enctype="multipart/form-data"
            class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="judul" x-model="form.judul"
                        ...
                        placeholder="Contoh: Blueprint TIK 2020-2024" required>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <label class="text-sm text-gray-700">Aktifkan dokumen ini</label>
                </div>
