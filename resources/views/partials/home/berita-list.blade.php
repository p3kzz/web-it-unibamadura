<div class="grid md:grid-cols-2 gap-6">
    @forelse ($newsItems as $item)
        <article
            ...
            <a href="{{ route('content.show', ['type' => 'news', 'slug' => $item->slug]) }}" class="block">
                ...
                <div class="p-5">
                    ...
                    <h3
                        class="font-bold text-gray-800 mt-1 mb-2 group-hover:text-uniba-blue transition-colors line-clamp-2">
                        {{ $item->title }}
                    </h3>
