<div x-data="{
    ...
    x-on:open-edit-category.window="
        open = true;
        form = {
            id: $event.detail.id,
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <form :action="`{{ url('admin_tik/kebijakan-kategori') }}/${form.slug}`" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="name" x-model="form.name"
                        ...
                        placeholder="Contoh: Kebijakan Keamanan" required>
                </div>
