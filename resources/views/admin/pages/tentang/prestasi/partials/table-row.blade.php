<tr class="hover:bg-blue-50 transition-colors duration-150 group">
    ...
    <td class="px-6 py-4 whitespace-nowrap text-center align-top">
        <span class="inline-flex items-center px-3 py-1.5 bg-blue-100 text-blue-700 text-sm font-semibold rounded-full">
            {{ $item->year }}
        </span>
    </td>
    ...
    <td class="px-6 py-4 align-top">
        <div class="flex items-center justify-center gap-2">
            <button @click="$dispatch('open-show-prestasi', {{ $item->toJson() }})" title="Lihat detail"
            ...
            <button @click="$dispatch('open-edit-prestasi', {{ $item->toJson() }})" title="Edit data"
