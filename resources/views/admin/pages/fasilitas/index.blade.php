...
@section('page-subtitle', 'Kelola data fasilitas')
...
@section('content')
    ...
    <div id="ajax-table-container">
        @include('admin.pages.fasilitas.partials.table')
    </div>

    @include('admin.pages.fasilitas.partials.form-create')

    @include('admin.pages.fasilitas.partials.form-edit')

    @include('admin.pages.fasilitas.partials.form-show')
