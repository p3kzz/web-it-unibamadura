<div x-data="{
    ...
    x-on:open-edit-renstra-dti.window="
        open = true;
        form = {
            id: $event.detail.id,
    ...
    <div @click.away="open = false" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-uniba-blue px-6 py-4 flex items-center justify-between sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">Edit Renstra DTI</h3>
        ...
        <form :action="`{{ url('admin_tik/renstra-dti') }}/${form.id}`" method="POST" enctype="multipart/form-data"
            class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">
                        Judul Renstra DTI <span class="text-red-500">*</span>
                    </label>
                ...
                <div>
                    ...
                    <x-form-summernote id="deskripsi-edit" name="deskripsi" :value="''" height="150" />
                </div>

                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">
                        File Renstra DTI (PDF)
                    </label>
                    <template x-if="form.file">
                        <div class="mb-3 p-3 bg-red-50 rounded-lg flex items-center gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <a :href="`/storage/${form.file}`" target="_blank"
                                    class="text-xs text-red-600 hover:underline">Lihat file</a>
                            </div>
                        </div>
                    </template>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Format: PDF. Maksimal 10MB. Biarkan kosong jika tidak ingin
                        mengubah.</p>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <label class="text-sm text-gray-700">Aktifkan Renstra DTI ini</label>
                </div>
