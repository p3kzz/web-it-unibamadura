...
@section('title', $emailAkuns->title . ' - Email & Akun Uniba Madura')
        ...
        <div class="container mx-auto px-4 relative z-10">
            <nav class="inline-flex text-blue-100 hover:text-white transition-colors">
                <ol class="flex items-center space-x-2 text-blue-300 text-sm">
                    ...
                    <li><a href="{{ route('email-akun.index') }}" class="hover:text-white transition-colors">Email
                            Akun</a></li>
                    <li><svg class="w-3.5 h-3.5 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg></li>
                    <li class="text-white font-medium truncate max-w-[180px]">{{ $emailAkuns->title }}</li>
                </ol>
            </nav>
            ...
            <div class="max-w-4xl mx-auto text-center">
                ...
                <p class="text-blue-100 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed animate-fade-in-up stagger-3">
                    {{ $emailAkuns->description ?: 'Informasi layanan email akun untuk mendukung layanan digital institusi.' }}
                </p>
            </div>
        </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="max-w-5xl mx-auto space-y-6">
                @forelse ($emailAkuns->sections as $index => $section)
                ...
                @if ($relatedEmailAkuns->isNotEmpty())
                    <div class="scroll-animate pt-2">
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Referensi layanan email akun lain yang tersedia</p>
                            </div>
                        </div>

                        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                            @foreach ($relatedEmailAkuns as $related)
                                <a href="{{ route('email-akun.show', $related->slug) }}"
